			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsapreunit-display": {
								"semanticObject": "zsapreunit",
								"action": "display",
								"description": "SAPUI5 For SAP Workflow",
								"title": "SAP Workflow",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsapreunit",
									"url": sap.ui.require.toUrl("zsapreunit")
								}
							}
						}
					}
